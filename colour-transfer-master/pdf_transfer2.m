...
%
function [DR,DR_full] = pdf_transfer2(D0, D1, Rotations, varargin)
...
for it=1:nb_iterations
    ...
    for i=1:nb_projs
        ...
        D0_fullR_(i,:) = (interp1(u, f', D0_fullR(i,:))-1)/(300-1)*(datamax-datamin) + datamin;
    end

    D0 = relaxation * (R \ (D0R_ - D0R)) + D0;
    
    D0_full = relaxation * (R \ (D0_fullR_ - D0_fullR)) + D0_full;
end
